                    ...
                    <div id='categories'>
                        ...
                        <div id='d'>
                            <div id='listProductsTitle'>
                                <?php
                                    $brand = $_GET["name"];
                                    $nameQuery = "select firstName from stores where storename='$brand'";
                                    ...
                                    echo "<p style='text-align: center;font-size: 30px;font-weight: bold;padding-top: 2%;color: black;'>$store</p>";
                                ?>
                            </div>
                            <div id='listProductsCont'>
                                <?php
                                    $prodQuery = "select * from productsd where brand='$brand'";
                                    $getProd = mysqli_query($conn, $prodQuery);

                                    if(mysqli_num_rows($getProd)>0) {
                                        while  ($row1 = mysqli_fetch_array($getProd)) {
                                            $idPro = $row1[0];
                                            $namePro = $row1[1];
                                            $categoryPro = $row1[2];
                                            $pricePro =$row1[8];
                                            echo "<div class='thePr'>
                                                    <div class='thePrImage' id='$idPro'>
                                                        <a class='$idPro' href='productDesigner.php?refProduct=$idPro'style='width:100%;height:100%;'>
