                    ...
                    <div id ="dir">
                        ...
                        <div id="listPro">
                            <?php
                                 ...
                                 $itemsQuery = "select pd.id, pd.name, pd.brand from productsd pd, products_pedidodesigners pp where pd.id = pp.idProduct and pp.idPedido ='$numPedido' ";
                        ...
                        <div id='letGo'>
                            <div id='dadosEnvio'>
                                <div id='theEnvio'>
                                    ...
                                    $moradaQuery = "select * from dados_enviodesigners where idPedido='$numPedido'";
                                    $getMorada = mysqli_query($conn, $moradaQuery);

                                    $rowM = mysqli_fetch_array($getMorada);

                                    $morada = $rowM[1];
                                    $codP = $rowM[2];
                                    $local = $rowM[3];

                                    echo "<p style='margin: 0;color: black;font-weight: bold;letter-spacing: 3px;padding-left: 4%;margin-bottom: 3%;'>Dados de Envio</p>";
                                    echo "<p style='margin: 0;font-size: 13px;font-weight: 100;padding-left: 4%;'>$morada</p>";
                                    echo "<p style='margin: 0;font-size: 13px;font-weight: 100;padding-left: 4%;'>$codP</p>";
                                    echo "<p style='margin: 0;font-size: 13px;font-weight: 100;padding-left: 4%;'>$local</p>";
                                    ?>
                                </div>
                            </div>
                            <div id='finish'>
