            ...
            <div class="containerStore">
                ...
                <div id='categories'>
                    ...
                    <div id='d'>
                            ...
                            <?php
                                    $prodQuery = "select * from productsd d, stores s where d.category='Botas' and (d.gender='M' or d.gender='U') and d.brand = s.storename and s.plano='Premium'";
                                    ...
                                    $prodQuery = "select * from productsd d, stores s where d.category='Botas' and (d.gender='M' or d.gender='U') and d.brand = s.storename and s.plano='Free'";
                                    $getProd = mysqli_query($conn, $prodQuery);
