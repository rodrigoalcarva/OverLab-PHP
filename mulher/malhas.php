                ...
                <div id='categories'>
                    ...
                    <div id='d'>
                            <div id='listProductsTitle'>
                                   ...
                                   <p style='text-align: center;font-size: 30px;font-weight: bold;padding-top: 2%;color: black;'>Malhas</p>
                            </div>
                            <div id='listProductsCont'>
                            <?php
                                    $prodQuery = "select * from productsd d, stores s where d.category='Malha' and (d.gender='F' or d.gender='U') and d.brand = s.storename and s.plano='Premium'";
                                    ...
                                    $prodQuery = "select * from productsd d, stores s where d.category='Malha' and (d.gender='F' or d.gender='U') and d.brand = s.storename and s.plano='Free'";
                                    $getProd = mysqli_query($conn, $prodQuery);
