...
<head>
  <meta charset="utf-8">
  <title>Cachecóis de Mulher</title>
                ...
                <div id='categories'>
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <?php
                                    $prodQuery = "select * from productsd d, stores s where d.category='Cachecol' and (d.gender='F' or d.gender='U') and d.brand = s.storename and s.plano='Premium'";
                                    ...
                                    $prodQuery = "select * from productsd d, stores s where d.category='Cachecol' and (d.gender='F' or d.gender='U') and d.brand = s.storename and s.plano='Free'";
                                    $getProd = mysqli_query($conn, $prodQuery);
