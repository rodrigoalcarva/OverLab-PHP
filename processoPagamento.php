                ...
                <div id = "info">
					<form action='phpScripts/storeScript2mao.php' method='post' enctype='multipart/form-data' style='width:100%;height:100%;'>
						...
						<div id='theMethod'>
							<div id='visaD'>
								<div id="visaForm">
									<input type='text' value='visa' name='metodo' style='display:none' id='metodoVisa'>
									<div class='numeroCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Número</label>
										<input id='numberVisa' style="margin-top: 3.5%;margin-left: 9%;width: 65%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;" id='ccn' type='tel'  maxlength='19' name='numeroCartao' inputmode='numeric'placeholder='xxxx-xxxx-xxxx-xxxx' >
									</div>
									<div class='titularCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Titular</label>
										<input id='titularVisa' style="margin-top: 3.5%;margin-left: 13%;width: 65%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;" name='titular' type="text" >
									</div>
									<div class='dataCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Validade</label>
										<select id='monthVisa' name="expirationMonth" notselectedlabel="Mês" style='margin-top: 3.5%;margin-left: 7%;width: 32%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;'  >
										...
										<select id='yearVisa' name="expirationYear" notselectedlabel="Ano" style='margin-top: 3.5%;margin-left: 0%;width: 31.5%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;' >
									...
									<div class='cvcCC'>
										...
										<input id='cvcVisa' style="margin-top: 3.5%;margin-left: 17%;width: 20%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;" maxlength='3' name="cvc" >
									</div>
								</div>
							</div>
							<div id='masterD'>
								<div id="masterForm">
									<input type='text' value='mastercard' name='metodo' style='display:none' id='metodoMaster'>
									<div class='numeroCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Número</label>
										<input id='numberMaster' style="margin-top: 3.5%;margin-left: 9%;width: 65%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;" id='ccn' type='tel'  maxlength='19' name='numeroCartao' inputmode='numeric'placeholder='xxxx-xxxx-xxxx-xxxx' >
									</div>
									<div class='titularCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Titular</label>
										<input id='titularMaster' style="margin-top: 3.5%;margin-left: 13%;width: 65%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;"  name='titular' type="text" >
									</div>
									<div class='dataCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Validade</label>
										<select id='monthMaster' name="expirationMonth" notselectedlabel="Mês" style='margin-top: 3.5%;margin-left: 7%;width: 32%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;'  >
											<option value="">Mês</option><option value="01">01</option>
											<option value="02">02</option><option value="03">03</option>
											<option value="04">04</option><option value="05">05</option>
											<option value="06">06</option><option value="07">07</option>
										...
										<select id='yearMaster' name="expirationYear" notselectedlabel="Ano" style='margin-top: 3.5%;margin-left: 0%;width: 31.5%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;' >
											<option value="">Ano</option>
											<option value="2020">2020</option>
											<option value="2021">2021</option>
											<option value="2022">2022</option>
									...
									<div class='cvcCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">CVC</label>
										<input id='cvcMaster' style="margin-top: 3.5%;margin-left: 17%;width: 20%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;" name="cvc" maxlength='3'  >
									</div>
								</div>
							</div>
							<div id='americanD'>
								<div id="americanForm">
									<input type='text' value='americanexpress' name='metodo' style='display:none' id='metodoAmerican'>
									<div class='numeroCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Número</label>
										<input id='numberAmerican' style="margin-top: 3.5%;margin-left: 9%;width: 65%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;" id='ccn' type='tel'  maxlength='19' name='numeroCartao' inputmode='numeric'placeholder='xxxx-xxxx-xxxx-xxxx' >
									</div>
									<div class='titularCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Titular</label>
										<input id='titularAmerican' style="margin-top: 3.5%;margin-left: 13%;width: 65%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;"  name='titular'type="text" >
									</div>
									<div class='dataCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">Validade</label>
										<select id='monthAmerican' name="expirationMonth" notselectedlabel="Mês" style='margin-top: 3.5%;margin-left: 7%;width: 32%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;'  >
											<option value="">Mês</option><option value="01">01</option>
											<option value="02">02</option><option value="03">03</option>
											<option value="04">04</option><option value="05">05</option>
											<option value="06">06</option><option value="07">07</option>
										...
										<select id='yearAmerican' name="expirationYear" notselectedlabel="Ano" style='margin-top: 3.5%;margin-left: 0%;width: 31.5%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;' >
											<option value="">Ano</option>
											<option value="2020">2020</option>
											<option value="2021">2021</option>
											<option value="2022">2022</option>
									...
									<div class='cvcCC'>
										<label style="margin:0%;float: left;font-size: 14px;padding-left: 4%;padding-top: 5%;">CVC</label>
										<input id='cvcAmerican' style="margin-top: 3.5%;margin-left: 17%;width: 20%;border: 1px solid black;background-color: #f9fafc;height: 55%;font-size: 13px;padding-left: 4%;" maxlength='3' name="cvc">
									</div>
								</div>
							</div>
							<div id='paypalD'>
								<input type='text' value='paypal' name='metodo' style='display:none' id='metodoPaypal'>
							...
							<div id='multiD'>
								<div id="multibancoForm">
									<input type='text' value='multibanco' name='metodo' style='display:none' id='metodoMb'>
									<div id='entiMulti'>
										...
										<input style='display:none;' name='entidade' value='20011' id='entidadeMb'>
									</div>
									<div id='refMulti'>
										...
										<?php echo "<input style='display:none;' name='referencia' value='$x' id='referenciaMb'>"; ?>
									</div>
								</div>
							</div>
						</div>
						<div id='continueConfirmation'>
							<div id='ppartePreco'>
								<div id='tot'>
									...
									<?php
										$itemCestoQuery = "select v.preco from venda2mao v, cesto c where c.idProduct = v.idProduct  and c.idUsername='$name'";
