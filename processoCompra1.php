    	...
    	<div class="hero-container" >
            <div id='cont'>
                ...
                <div id = "info">
                    ...
                    <div id ="itemsCesto">
                        <?php
                            $itemCestoQuery = "select c.idProduct, p.name, p.color, c.tamanho, c.quant, p.preco from cestodesigners c INNER JOIN productsd p ON (c.idProduct = p.id and c.idUsername='$name')";
                            ...
                            while  ($row = mysqli_fetch_array($getItemCesto)) {
                                ...
                                echo"<div class='itemCesto'>
                                    ...
                                    <div class='pco1'>
                                        <p style='padding-top: 8%;text-align: center;font-weight: 500;font-size: 18px; color:black'>".$precoTotal."€</p>
                                    </div>
                                </div>";
                            }
                        ?>
                    ...
                    <div id='moradaEnviar'>
                        <form action='phpScripts/storeScriptDesigner.php' method='post' enctype='multipart/form-data' style='width:100%;height:100%;'>
                            <div id='morada'>
                                ...
                                <div id='moradaForm'>
                                    <input type="text" name="morada" placeholder="Morada" style="border: 1px solid black;width: 30%;background-color: #f9fafc;height: 54%;font-size: 13px;margin-top: 3%;padding-left: 2%;" required>
                                    <input type="text" name="codigoPostal"style="border: 1px solid black;width: 30%;background-color: #f9fafc;height: 54%;font-size: 13px;margin-top: 3%;padding-left: 2%;"placeholder="Código Postal" required>
                                    <input type="text" name="local" style="border: 1px solid black;width: 30%;background-color: #f9fafc;height: 54%;font-size: 13px;margin-top: 3%;padding-left: 2%;" placeholder="Cidade" required>
                                </div>
                            </div>
                            <div id='continuar'>
                                <div id='precoTotal'>
