                    ...
                    <form id="formEdit" action="<?=htmlspecialchars(stripslashes(trim("phpScripts/userpageScript.php")));?>" method="post" enctype="multipart/form-data">
                        <div id="cimaEdit">
                            ...
                            <div class="input-div five">
                                    ...
                                    <div>
                                        <select class="form-control" name="gender" id="questionSelect" >
                        ...
                        <div id="baixoEdit">
                            ...
                            <div id="baixoEditSubmit">
                                <div id="submits">
                                 <input type="submit" class="btn" name="save" value="Salvar" style="width: 25%;margin: 0;height: 70%;float: right;margin-right: 2%;">
                                 <a href="userpage.php" style="float: right;margin-right: 4%;padding-top: 1.5%;color: black;">Cancelar</a>
                                </div>
                            </div>
                        </div>
                    </form>
