                      ...
                      if ($row[10] =='Free'){
                                ...
                                <div id='paymentPaypal'>
                                    ...
                                    <form class='theForm' action='phpScripts/userpageScript.php' method='post' enctype='multipart/form-data'>
                                        ...
                                        <div class='submitPayment'>
                                            <input type='submit' class='btn' name='overlabPremiumUserPP' value='Subscrever Premium' style='width: 70%;margin: 0;margin-left: 15%;height: 70%;margin-right: 2%;'>
                                        </div>
                                    </form>
                                </div>
                                <div id='paymentCard'>
                                    ...
                                    <form class='theForm' action='phpScripts/userpageScript.php' method='post' enctype='multipart/form-data'>
                                        ...
                                        <div class='submitPayment'>
                                            <input type='submit' class='btn' name='overlabPremiumUserCC' value='Subscrever Premium' style='width: 70%;margin: 0;margin-left: 15%;height: 70%;margin-right: 2%;'>
                                        </div>
                                    </form>
                                </div>
                            </div>";
                        ...
                        echo "<div id='paymentPremium'>
                                ...
                                <div class='submitPremium'>
                                  	...
                                  	<input type='submit' class='btn' name='overlabFreeUser' value='Cancelar Premium' style='width: 70%;margin: 0;margin-left: 15%;height: 64%;margin-top: 3%;'>
																	</form>
																</div>
                              </div>";
                      }
    ...
    <section id="hero1" style="width: 100%;height: 100vh;background-size: cover;position: relative;background-color: #f9fafc;">
        <div id='historicSubs' style="width:56%;height:100%;margin-left:44%;">
            ...
            <div id='historicSubsContainer'>
                <?php
                    $subsQuery = "select * from subscriptionusers where idUsername='$username'";
                        ...
                        while  ($row = mysqli_fetch_array($getsSubs)) {
                            ...
                            echo"<div class='theFact'>
                                <div class='theFactEsq'>
                                    <p style='font-size: 27px;color: black;font-weight: 100;padding-top: 17%;padding-left:6%;'>Subscrição #$idSub</p>
                                </div>
                                ...
                                <div class='theFactDir'>
                                    <a href='.\pdfSubsUsers\sub".$idSub."_".$mes."_"."$ano"."_".$username.".pdf' target='_blank' style='    width: 75%;
